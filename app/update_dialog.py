...
class UpdateManager(QObject):
    ...
    def _download_done(
        ...
        # Confirm one more time before swapping
        reply = QMessageBox.question(
            self._window,
            "Restart to apply update?",
            f"HicoForge v{info.version} has been downloaded.\n\n"
            "Clicking Restart will close HicoForge, swap in the new version, "
            "and reopen it. Your settings will be preserved.",
        ...
        try:
            launch_updater(result["path"], current_version())
        ...
        # Close the app cleanly so the .bat can take over
